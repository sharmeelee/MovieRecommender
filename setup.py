...
setup( 
	...
	install_requires=['torch', 'numpy', 'os', 'sys', 'time', 'pandas', 'zipfile', 'tarfile', 'requests', 'matplotlib.pyplot', 'scipy.sparse', 'implicit', 'sklearn'] #external packages as dependencies 
)
