...
testdata = {'user_id': [1, 2, 3, 5, 5], 'item_id': [4, 5, 6, 7, 7],
            'rating': [1, 2, 3, 4, 5], 'timestamp': [10, 11, 12, 12, 12]}
...
class TestProcessData(unittest.TestCase):
    ...
    # make sure it comes back without timestamp or that it matches columns
